...
rf = RandomForestRegressor(max_features='sqrt', random_state=4, n_estimators=480)
gb = GradientBoostingRegressor(random_state=1, n_estimators=100, max_features='auto')
...
# Accuracy on test set 0.5154419568633473